...
FUNDA_URL = "https://www.funda.nl/en/huur/amsterdam/straat-museumplein/1000-1500/+2km/sorteer-datum-af/"
...
print("The db is updated with the latests posts.")
...
# posts = scrape_webpage(webpage)
# last_posts: list = get_last_posts()
# posts_to_notify = select_posts_to_notify(posts, last_posts)
# new_last_posts = get_new_last_posts(posts)
# update_last_posts(new_last_posts)
# notify(posts_to_notify)
